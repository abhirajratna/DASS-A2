...
class Bank:
    ...
    def collect(self, amount):
        """
        Apply a signed cash-flow amount to bank reserves.
        Positive values increase reserves (taxes, fines, auction proceeds);
        negative values decrease reserves (e.g., mortgage payouts).
        """
        self._funds += amount
